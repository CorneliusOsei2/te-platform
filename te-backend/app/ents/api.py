...
from app.ents.company.endpoints import user_referral_router as user_referral_router
...
api_router.include_router(user_referral_router, tags=["User Referral Endpoints"])
